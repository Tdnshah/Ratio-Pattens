...
activity3q1.prototype = {
	preload:function(){
		this.load.image('a3q2Background','assets/images/activity3/BACK_GROUND_Q2.png');
//		this.load.image('answerActivity1','assets/images/activity3/answerActivity1.png');
		/* rev2.0 Code*/
		if(gameStartTime == '0'){
...
//            modalCloseOnInput: true,
	...
	onSubmit: function(){
		if (input1.value == 8 && input2.value == 1 && input3.value == 32 && input4.value == 4){
			attemptCount ++;
			this.showModalCorrectAttempt();
			/*rev 2.0 code*/
			var attempt = {};
			attempt['attemptNo'] = attemptCount;
			attempt['correctAnswer'] = (input1.value == 8 && input2.value == 1 && input3.value == 32 && input4.value == 4);
		...
		else if (input1.value != 8 || input2.value != 1 || input3.value != 32 || input4.value != 4){
			if(attemptCount < 1){
				attemptCount ++;
	...
	dataPost: function(){
		...
		appData['Activity3Q1'] = activityLevel1;
		appData['Activity3Q2'] = activityLevel2;
