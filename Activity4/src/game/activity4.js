...
activity4.prototype = {
	...
	preload: function () {
		...
		this.load.image('paintBrushGreen','assets/images/greenpntbrsh.cur');
		this.load.image('paintBrushRed','assets/images/activity3/answeActivity3.png');
            ...
            itemsArr: [
              {
				...
				{
                    type: "text",
                    content:this.translate('incorrectAnswerModalGrid1attemptsText5'),
                    fontFamily: "Arial",
                    fontSize:14,
                    color: "0xFF0000",
                    offsetY:-35,
	...
	onSubmit: function () {
		if (rows == 4 && columns == 4){
			if (this.arraysIdentical(studentInputArray, correctAnswer) == true) {
				...
				attempt["answerGridCorrect"] = (rows == 4 && columns == 4);
