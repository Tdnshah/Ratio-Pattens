...
activity1.prototype = {
	...
	create: function () {
		...
		var questionText = "नीचे दिए गए पैटर्न को इस प्रकार बड़ा करें ताकि यह ग्रिड\nको पूरी तरह से भर दे।यह नया पैटर्न बिल्कुल मूल पैटर्न जैसा\nदिखना चाहिए, सिर्फ़ साईज़ बड़ा हो।"
		...
		var instructionText = "हरे और लाल रंगपट्टी से ग्रिड को भरें। अपने उत्तर की जांच\nके लिए सबमिट पर क्लिक करें। "
	...
	createModals: function () {
		...
		reg.modal.createModal({
			...
			//            modalCloseOnInput: true,
				itemsArr: [
					...
					{
						type: "text",
						content: "आपने सही तरीके से आकृति को बड़ा किया\nऔर पहेली को हल कर लिया है !",
						fontFamily: "Arial",
						fontSize: 16,
						align: "left",
						color: "black",
			...
			reg.modal.createModal({
				...
				itemsArr: [
					...
					{
						type: "text",
						content: "2.मूल आकृति के बड़े रूप जैसा 	दिखे।",
						fontFamily: "Arial",
						fontSize: 14,
						color: "black",
						offsetY: -60,
					...
					{
						type: "text",
						content: "ग्रिड को साफ करने के लिए दुबारा सजायें (रीसेट) पर क्लिक करे।",
						fontFamily: "Arial",
						fontSize: 14,
						color: "0xFF0000",
						offsetY: -35,
		...
		reg.modal.createModal({
			...
			itemsArr: [
				...
				{
					type: "text",
					content: "जब मूल आकृति को बड़ा किया जाता है और ग्रिड भर जाती है,\nतो वह ऐसी लगती है:",
					fontFamily: "Arial",
					fontSize: 14,
					align: "left",
					color: "black",
