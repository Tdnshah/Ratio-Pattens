...
//		preloading Of all the game images
		...
		this.load.atlas('buttons','assets/images/activity1/SpriteSheets/buttons.png','assets/images/activity1/SpriteSheets/buttons.json');
		this.load.atlas('tiles','assets/images/activity1/SpriteSheets/tiles.png','assets/images/activity1/SpriteSheets/tiles.json');
		this.load.atlas('popupsItems','assets/images/activity1/SpriteSheets/popup_items.png','assets/images/activity1/SpriteSheets/popup_items.json');
		this.load.atlas('soundMute','assets/images/activity1/SpriteSheets/sound.png','assets/images/activity1/SpriteSheets/sound.json');
		this.load.atlas('popupButtons','assets/images/activity1/SpriteSheets/popupButtons.png','assets/images/activity1/SpriteSheets/popupButtons.json');
...
//		prelaoding of all the game sounds
		...
		this.load.audio('claps','assets/sounds/Claps.mp3');
