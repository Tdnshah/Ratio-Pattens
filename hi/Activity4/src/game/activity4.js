...
activity4.prototype = {
	...
	create: function () {
		...
		var questionText = "दिए गए पैटर्न को 2 के गुणक में छोटा  करें।"
...
//            modalCloseOnInput: true,
            itemsArr: [	
				...
				
				{
				  ...
				  {
                    type: "text",
                    content: "आपने सही तरीके से आकृति को छोटा किया और पहेली को हल\nकर लिया है।आप इनाम जीतने से एक कदम दूर हैं !",
                    fontFamily: "Arial",
                    fontSize:16,
					align: "left",
                    color: "black",
            ...
            itemsArr: [
              {
				...
				{
                    type: "text",
                    content:"जब मूल आकृति को 2 के गुणक से घटाया जाता है, तो यह इस\nप्रकार दिखता है :",
                    fontFamily: "Arial",
                    fontSize:16,
					align:"left",
                    color: "black",
            ...
            itemsArr: [
              {
				...
				{
                    type: "text",
                    content:"आपको आकृति का साइज़ 2 के गुणक से घटाना  है।",
                    fontFamily: "Arial",
                    fontSize:16,
                    color: "black",
                    offsetY:-75,
