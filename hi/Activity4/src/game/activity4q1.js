...
//		adding the question text
		var questionText ="मूल और छोटी की गई आकृतियों की तुलना करें और नीचे \nदी गई सारणी को पूरा करें। " 
...
//		adding the instructional text
		var instructionText = "अपना उत्तर पूर्ण संख्या के रूप में एंटर करें और अपने उत्तर की \nजांच के लिए सबमिट पर क्लिक करें । "
...
//            modalCloseOnInput: true,
            itemsArr: [	
				...
				
				{
				  ...
				  {
                    type: "text",
                    content: "आपने दोनों आकृतियों में हरी और लाल पट्टियों की संख्या\nकी गणना सही की है।",
                    fontFamily: "Arial",
                    fontSize:16,
					align: "left",
                    color: "black",
            ...
            itemsArr: [
              {
				...
				{
                    type: "text",
                    content:"मूल आकृति में 8 लाल और 56 हरी पट्टियाँ हैं।\nबड़ी हुई आकृति में 2 लाल और 14 हरी पट्टियाँ हैं। ",
                    fontFamily: "Arial",
                    fontSize:16,
                    color: "black",
                    offsetY:-80,
